...
const MobileNav = () => {
  ...
  return (
    <>
        ...
        <div className={`lg:hidden bg-slate-950/90 h-[100vh] w-[60vw] flex flex-col justify-start items-center gap-2 pb-6 pt-4 pl-4 pr-16 fixed top-0 z-50 transition-transform duration-700 translate-x-[100vw] ${isClose ? 'translate-x-[100vw]' : 'translate-x-[40vw]'}`}>
