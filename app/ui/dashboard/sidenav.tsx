...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col pb-3 pt-2 md:px-2">
      <div className="flex justify-start items-center lg:h-24 h-[5rem] lg:pb-4 px-4 gap-4">
        <Link className="bg-rose-500 w-16 aspect-square p-1 rounded-lg flex justify-center items-center text-yellow-300 hover:text-yellow-500" href="/" >
        ...
        <div className='dark:text-slate-50 text-2xl'>
          Deadline
        </div>
        <MobileNav />
      </div>
