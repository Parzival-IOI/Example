...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col md:px-2">
      <div className="flex justify-start items-center lg:h-20 h-[3rem] lg:pb-2 px-4 gap-4">
        <Link className="bg-rose-500 w-[2rem] aspect-square p-1 rounded-lg flex justify-center items-center text-yellow-300 hover:text-yellow-500" href="/" >
        ...
        <div className='dark:text-slate-50 text-md'>
          Deadline
        </div>
        <MobileNav />
      </div>
